...
def go():
    ...
    outHandle.write("bacteriocin \t organism \t organismSt \t organismEnd \t strand \t gene \t geneSt \t strand \t bacterciocin_sequence\n")
